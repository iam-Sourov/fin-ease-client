    ...
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className=" grid  grid-cols-1 md:grid-cols-3 place-items-center gap-6 -mt-16">
                <div className="w-80 h-48 p-6 bg-linear-to-br from-blue-600/20 to-blue-800/20 rounded-2xl shadow-lg flex flex-col justify-between transform transition-all hover:scale-105">
                ...
                <div className="w-80 h-48 p-6 bg-linear-to-br from-green-600/20 to-green-800/20 rounded-2xl shadow-lg  flex flex-col justify-between transform transition-all hover:scale-105">
                    <div className="flex justify-between items-start">
                        <div className="w-12 h-9 shadow-inner flex items-center justify-center">
                            <img src={sim} alt="" />
                ...
                <div className="w-80 h-48 p-6 bg-linear-to-br from-red-600/20 to-red-800/20 rounded-2xl shadow-lg  flex flex-col justify-between transform transition-all hover:scale-105">
                    <div className="flex justify-between items-start">
                        <div className="w-12 h-9 shadow-inner flex items-center justify-center">
                            <img src={sim} alt="" />
