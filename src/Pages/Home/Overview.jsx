...
const Overview = () => {
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* We use a negative margin to pull this section up over the banner */}
            <div className=" grid  grid-cols-1 md:grid-cols-3  gap-6   -mt-16">
                ...
                <div class="w-80 h-48 p-6 bg-linear-to-br from-green-500 to-green-700 rounded-2xl shadow-lg text-white flex flex-col justify-between transform transition-all hover:scale-105">
                    <div class="flex justify-between items-start">
                        ...
                        {/* <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.105 0 2 .895 2 2s-.895 2-2 2-2-.895-2-2 .895-2 2 2zm0 8c-1.105 0-2 .895-2 2s.895 2 2 2 2-.895 2-2-.895-2-2 2zm0-4c-1.105 0-2 .895-2 2s.895 2 2 2 2-.895 2-2-.895-2-2 2z"></path></svg> */}
                    </div>
                    <div class="text-2xl font-mono tracking-wide">
                        $ 5,678.90
                    </div>
